...
?>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #0d6efd 0%, #0055cc 100%); color: white;">
        <div class="container-lg">
            <h1 class="display-4 fw-bold mb-3">Lokasi Sekolah</h1>
            <p class="lead">Temukan kami dengan mudah</p>
        </div>
    </section>
                ...
                <div class="col-lg-8">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-0">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.8516850227697!2d107.22847!3d-7.205361!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e687e9e5e9e9e9d%3A0x4444444444444444!2sJln.%20Jendral%20Sudirman%20No.123%2C%20Garut!5e0!3m2!1sid!2sid!4v1234567890123" width="100%" height="500" style="border:0; border-radius: 0.3rem;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade;"></iframe>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <table class="table table-sm mb-0">
                                <tbody>
                                    <tr>
                                        <td>Senin - Jumat</td>
                                        <td class="fw-bold">07:00 - 15:30</td>
                                    </tr>
                                    <tr>
                                        <td>Sabtu</td>
                                        <td class="fw-bold text-warning">Tutup</td>
                                    </tr>
                                    <tr>
                                        <td>Minggu</td>
                                        <td class="fw-bold text-warning">Tutup</td>
    ...
    <section class="py-5 bg-light">
        <div class="container-lg">
            <h3 class="fw-bold mb-4 text-center">Fasilitas & Transportasi</h3>
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold mb-3">
                                <i class="bi bi-buildings text-primary me-2"></i>Fasilitas Sekolah
                            </h5>
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Parkir Luas</li>
                            </ul>
                        </div>
                    </div>
                </div>
